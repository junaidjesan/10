            ...
            <div>
                <figure className="carousel w-full">
                    <figure id="slide1" className="carousel-item relative w-full">
                        <img src="https://images.unsplash.com/photo-1581092160607-ee22621dd758?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" className="w-full h-4/12 md:h-96 object-cover" />
                        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                            <a href="#slide4" className="btn btn-circle">❮</a>
                            <a href="#slide2" className="btn btn-circle">❯</a>
                        </div>
                        <figcaption className='absolute inset-x-0 bottom-1 z-20 md:w-96 mx-auto p-4 font-light text-center tracking-widest text-black md:text-4xl leading-snug bg-gray-300 bg-opacity-25'>Welcome to Engineer's School</figcaption>
                    </figure>
                    <figure id="slide2" className="carousel-item relative w-full">
                        <img src="https://images.unsplash.com/photo-1581092160562-40aa08e78837?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" className="w-full h-4/12 md:h-96 object-cover" />
                        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                            <a href="#slide1" className="btn btn-circle">❮</a>
                            <a href="#slide3" className="btn btn-circle">❯</a>
                        </div>
                        <figcaption className='absolute inset-x-0 bottom-1 z-20 md:w-96 mx-auto p-4 font-light  text-center tracking-widest md:text-3xl text-black leading-snug bg-gray-300 bg-opacity-25'>Learn With us and gain your favorite Degree</figcaption>
                    </figure>
                    <figure id="slide3" className="carousel-item relative w-full">
                        <img src="https://images.unsplash.com/photo-1581091877018-dac6a371d50f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" className="w-full h-4/12 md:h-96 object-cover" />
                        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                            <a href="#slide2" className="btn btn-circle">❮</a>
                            <a href="#slide4" className="btn btn-circle">❯</a>
                        </div>
                        <figcaption className='absolute inset-x-0 bottom-1 z-20 md:w-96 mx-auto p-4 font-light md:text-3xl text-center tracking-widest text-black leading-snug bg-gray-300 bg-opacity-25'>Learn with Examples and practical</figcaption>
                    </figure>
                    <figure id="slide4" className="carousel-item relative w-full">
                        <img src="https://images.unsplash.com/photo-1581090466619-e945d2e2980e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" className="w-full h-4/12 md:h-96 object-cover" />
                        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                            <a href="#slide4" className="btn btn-circle">❮</a>
                            <a href="#slide1" className="btn btn-circle">❯</a>
                        </div>
                        <figcaption className='absolute inset-x-0 bottom-1 z-20 md:w-96 mx-auto p-4 font-light md:text-3xl text-center tracking-widest text-black leading-snug bg-gray-300  bg-opacity-25'>Take guid from our world class mentor</figcaption>
                    </figure>
                </figure>
            </div>
